<%-- 
    Document   : kidsapparel2
    Created on : Dec 7, 2014, 2:25:11 PM
    Author     : S521776
--%>
...
<!--						<li class="first"><a href="jewelry.jsp">ON SALE</a></li>
						...
						<li><a href="blog.jsp">THE BLOG</a></li>-->
					</ul>
					<ul>
                                            <li><a href="NewDeals.jsp">New Deals</a></li>
                                            <li><a href="about.jsp">About us</a></li>
<!--						<li><a href="shoes.jsp">My Collection</a></li>-->
...
<!--					<li><a href="accessories.jsp">Accessories</a></li>
  ...
  <ul>
     <li ><a href="kidsapparel.jsp" title="Home">T-Shirts</a></li>
      ...
      <li class="selected"><a href="kidsapparel2.jsp" title="Services">Hoodies</a></li>
...
<!--				<div class="figure">
				...
				<div class="products">
					...
					<ul>
						<li class="first">
                                                    <a href="ApparelServlet?name=kh1.jpg"  >
                                                        <img src="images/kh1.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=kh2.jpg"><img src="images/kh2.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=kh3.jpg"><img src="images/kh3.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=kh4.jpg"><img src="images/kh4.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
					...
					<ul>
						<li class="first">
							<a href="ApparelServlet?name=kh5.jpg"><img src="images/kh5.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=kh6.jpg"><img src="images/kh6.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=kh7.jpg"><img src="images/kh7.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=kh8.jpg"><img src="images/kh8.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
