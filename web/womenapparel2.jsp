<%-- 
    Document   : womenapparel2
    Created on : Dec 7, 2014, 2:33:04 PM
    Author     : S521776
--%>
...
<!--					<li><a href="accessories.html">Accessories</a></li>
  ...
  <ul>
     <li><a href="womenapparel.html" title="Home">Tops</a></li>
      ...
      <li class="selected"><a href="womenapparel2.html" title="Services">Jeans</a></li>
...
<!--				<div class="figure">
				...
				<div class="products">
					...
					<ul>
						<li class="first">
                                                    <a href="ApparelServlet?name=wj1.jpg"  >
                                                        <img src="images/wj1.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=wj2.jpg"><img src="images/wj2.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=wj3.jpg"><img src="images/wj3.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=wj4.jpg"><img src="images/wj4.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
					...
					<ul>
						<li class="first">
							<a href="ApparelServlet?name=wj5.jpg"><img src="images/wj5.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=wj6.jpg"><img src="images/wj6.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=wj7.jpg"><img src="images/wj7.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=wj8.jpg"><img src="images/wj8.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
