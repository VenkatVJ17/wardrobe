...
function init_v_menu(a){
    if(window.addEventListener)
        window.addEventListener("load", function(){ start_v_menu(a);},false);
        else window.attachEvent&&window.attachEvent("onload",function(){start_v_menu(a);});}
...
function start_v_menu(i){
    ...
    for(var k=function(a,b){if(a.id===i.menuId)return b;else{b+=a.offsetTop;return k(a.parentNode.parentNode,b);}},a=0;a<b.length;a++){
