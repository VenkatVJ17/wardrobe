<%-- 
    Document   : adminAddDeal
    Created on : Dec 7, 2014, 2:21:55 PM
    Author     : S521776
--%>
...
<!--						<li><a href="about.html">Apparel Status</a></li>
			...
			<div id="navigation">
				<ul>
                                    ...
                                    <li class="selected"><a href="adminAddDeal.html">Make a Deal</a></li>
					...
					<br>
                                    ...
                                    <fieldset style="min-width: 100px;border-radius: 10px;width: 60%;display: inline-block; border: 3px solid">
                                        ...
                                        style="width: 250px;float: right;border: 1px solid;border-radius: 10px;"/></p>
                                            ...
                                            <p>Effective To <input style=" width: 250px;float: right;" type="text" id="datepicker1"></p>
