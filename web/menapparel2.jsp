<%-- 
    Document   : menapparel2
    Created on : Dec 6, 2014, 1:09:39 AM
    Author     : S521776
--%>
...
<!--					<li><a href="accessories.html">Accessories</a></li>
		...
		<div class="body">
			<div class="sidebar">
				<div class="first">
	<div id="menu8">
  <ul>   <li ><a href="menapparel.jsp" title="Home">T-Shirts</a></li>
    <li ><a href="menapparel1.jsp" title="About">Shirts</a></li>
    <li class="selected"><a href="menapparel2.jsp" title="Services">Jeans</a></li>
...
<!--				<div class="figure">
				...
				<div class="products">
					...
					<ul>
						<li class="first">
                                                    <a href="ApparelServlet?name=mj1.jpg"  >
                                                        <img src="images/mj1.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=mj2.jpg"><img src="images/mj2.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=mj3.jpg"><img src="images/mj3.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=mj4.jpg"><img src="images/mj4.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
					...
					<ul>
						<li class="first">
							<a href="ApparelServlet?name=mj5.jpg"><img src="images/mj5.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=mj6.jpg"><img src="images/mj6.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=mj7.jpg"><img src="images/mj7.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=mj8.jpg"><img src="images/mj8.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
