<%-- 
    Document   : removeApparelSuccess
    Created on : Dec 7, 2014, 2:30:28 PM
    Author     : S521776
--%>
...
<html>
    ...
    <body>
        ...
        <div class="header">
            ...
            <div id="navigation">
                <ul>
                                    ...
                                    <li ><a href="adminPendingDeals.jsp">Pending New Apparels</a></li>
                                        <li ><a href="adminModifyDeals.html">Modify Apparels</a></li>
					<li class="selected"> <a href="adminRemoveApparels.html">Remove Apparels</a></li>
            ...
            <div class="body">
<!--                <div class="featured">
<h2><a href="adminAddDeal.html" style="margin-left:5%;margin-top: 10%;display: inline-block;height: 20px;">Make a Deal</a>
...
<!--			
                    ...
                    <div  style="margin-left:20%;">
                        ...
                        <fieldset style="margin-top: 5%;min-width: 100px;border-radius: 10px;width: 70%;display: inline-block; border: 3px solid">
                            <h2>Success...</h2>
                            <p>You have purchased item successfully.</p>
                            <p>Your order number XXXXXXX1013</p>
                            <p>Thank you...</p>
