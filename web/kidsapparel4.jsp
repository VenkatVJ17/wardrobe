<%-- 
    Document   : kidsapparel4
    Created on : Dec 7, 2014, 2:26:08 PM
    Author     : S521776
--%>
...
<!--					<li><a href="accessories.jsp">Accessories</a></li>
	...
	<div id="menu8">
  <ul>
      <li ><a href="kidsapparel.jsp" title="Home">Tops</a></li>
      <li><a href="kidsapparel1.jsp" title="About">Shirts</a></li>
      <li><a href="kidsapparel2.jsp" title="Services">Jeans</a></li>
      <li><a href="kidsapparel3.jsp" title="Portfolio">Hoodies</a></li>
<!--    <li class="selected"><a href="womenapparel4.jsp" title="Store">Trousers</a></li>-->
  </ul>
</div>
                                </div>
...
<!--				<div class="figure">
				...
				<div class="products">
					...
					<ul>
						<li class="first">
                                                    <a href="ApparelServlet?name=wt1.jpg"  >
                                                        <img src="images/wt1.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=wt2.jpg"><img src="images/wt2.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=wt3.jpg"><img src="images/wt3.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=wt4.jpg"><img src="images/wt4.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
					...
					<ul>
						<li class="first">
							<a href="ApparelServlet?name=wt5.jpg"><img src="images/wt5.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=wt6.jpg"><img src="images/wt6.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=wt7.jpg"><img src="images/wt7.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=wt8.JPG"><img src="images/wt8.JPG" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
