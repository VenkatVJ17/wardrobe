<%-- 
    Document   : menapparel3
    Created on : Dec 6, 2014, 1:09:47 AM
    Author     : S521776
--%>
...
<!--					<li><a href="accessories.html">Accessories</a></li>
  ...
  <ul>
    ...
    <li class="selected"><a href="menapparel3.jsp" title="Portfolio">Hoodies</a></li>
...
<!--				<div class="figure">
				...
				<div class="products">
					...
					<ul>
						<li class="first">
                                                    <a href="ApparelServlet?name=hd1.jpg"  >
                                                        <img src="images/hd1.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=hd2.jpg"><img src="images/hd2.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=hd3.jpg"><img src="images/hd3.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=hd4.jpg"><img src="images/hd4.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
					...
					<ul>
						<li class="first">
							<a href="ApparelServlet?name=hd5.jpg"><img src="images/hd5.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=hd6.jpg"><img src="images/hd6.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=hd7.jpg"><img src="images/hd7.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=hd8.jpg"><img src="images/hd8.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
