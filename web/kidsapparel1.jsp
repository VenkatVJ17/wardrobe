<%-- 
    Document   : kidsapparel1
    Created on : Dec 7, 2014, 2:24:29 PM
    Author     : S521776
--%>
...
<!--					<li><a href="accessories.html">Accessories</a></li>
	...
	<div id="menu8">
  <ul>
<li ><a href="kidsapparel.html" title="Home">T-Shirts</a></li>
      <li class="selected"><a href="kidsapparel1.html" title="About">Skirts</a></li>
      <li><a href="kidsapparel2.html" title="Services">Hoodies</a></li>
      <li><a href="kidsapparel3.html" title="Portfolio">Jeans</a></li>
...
<!--				<div class="figure">
				...
				<div class="products">
					...
					<ul>
						<li class="first">
                                                    <a href="ApparelServlet?name=skt1.jpg"  >
                                                        <img src="images/skt1.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=skt2.jpg"><img src="images/skt2.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=skt3.jpg"><img src="images/skt3.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=skt4.jpg"><img src="images/skt4.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
					...
					<ul>
						<li class="first">
							<a href="ApparelServlet?name=skt5.jpg"><img src="images/skt5.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=skt6.jpg"><img src="images/skt6.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=skt7.jpg"><img src="images/skt7.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
						<li>
							<a href="ApparelServlet?name=skt8.jpg"><img src="images/skt8.jpg" alt=""/></a>
							<h4>Lorem Ipsum</h4>
							<p>dolor sit amet</p>
							<span>US$28.00 ~PHP1,210.44</span>
						</li>
